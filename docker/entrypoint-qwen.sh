...
echo "  cd src"
echo "  python run_eval.py --config ../experiments/bidir_attn/configs/config_qwen_smoke.json --run_step reason"
echo "  python run_eval.py --config ../experiments/bidir_attn/configs/config_qwen_large.json --run_step reason"
echo ""
echo "  # 4. Run judge (needs OPENAI_API_KEY)"
echo "  export OPENAI_API_KEY=..."
echo "  python run_eval.py --config ../experiments/bidir_attn/configs/config_qwen_smoke.json --run_step judge"
echo "  python run_eval.py --config ../experiments/bidir_attn/configs/config_qwen_large.json --run_step judge"
echo ""
